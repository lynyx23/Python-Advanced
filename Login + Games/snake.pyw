...
os.environ['SDL_VIDEO_WINDOW_POS'] = "%i,%i" % (window_x/2-300,window_y/2-300)
...
head_path=os.path.join(full_path+r"\resources\head.png")
tail_path=os.path.join(full_path+r"\resources\tail1.png")
apple_path=os.path.join(full_path+r"\resources\apple2.png")
eat_path=os.path.join(full_path+r"\resources\eat.ogg")

snake_img = pygame.image.load(head_path)
apple_img = pygame.image.load(apple_path)
tail_img = pygame.image.load(tail_path)
