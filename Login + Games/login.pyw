...
def start_dino():
    dino_path=os.path.join(full_path+"\start.pyw")
    Home.withdraw()
...
def HomeWindow():
    ...
    btn_back=Button(Home,text="Back to Login",font=('comic sans ms',25),command=Back).pack(pady=25)
    dino_btn_play=Button(Home,text="Play Dino Game",font=('comic sans ms',25),command=start_dino).pack(pady=25)
    snake_btn_play=Button(Home,text="Play Snake Game",font=('comic sans ms',25),command=start_snake).pack(pady=25)
