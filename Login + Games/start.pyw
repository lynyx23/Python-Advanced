...
os.environ['SDL_VIDEO_WINDOW_POS'] = "%i,%i" % (window_x/2-300,window_y/2-150)

pygame.init()

full_path=os.path.dirname(os.path.realpath(__file__))
sound_path=os.path.join(full_path,'sounds')
sprite_path=os.path.join(full_path,'sprites')

screen_size_display = (width_screen, height_screen) = (600, 300)
FPS = 60
gravity = 0.6
...
pygame.display.set_caption("Dino Dan")

jump_sound_location=os.path.join(sound_path,'jump.ogg')
die_sound_location=os.path.join(sound_path,'die.ogg')
checkPoint_sound_location=os.path.join(sound_path,'checkPoint.ogg')

jump_sound = pygame.mixer.Sound(jump_sound_location)
die_sound = pygame.mixer.Sound(die_sound_location)
checkPoint_sound = pygame.mixer.Sound(checkPoint_sound_location)
...
def load_image(
    ...
    fullname = os.path.join(sprite_path, name)
...
def load_sprite_sheet(
    ...
    fullname = os.path.join(sprite_path, s_name)
